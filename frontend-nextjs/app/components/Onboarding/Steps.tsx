...
const Steps: React.FC<{
    ...
    let heading = "Let's get your Smart Murti device & account set up";
    let subHeading =
        "We want to make sure that your Smart Murti is set up to provide you the best experience possible.";

    if (step === 1) {
        {
            heading = "Hello there!";
            subHeading =
                "With the following details we will be able to personalize your Smart Murti experience.";
        }
    }
