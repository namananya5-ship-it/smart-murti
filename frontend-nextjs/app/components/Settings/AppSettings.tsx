    ...
    return (
        <>
            ...
            <div className="space-y-4 max-w-screen-sm mt-12">
                ...
                {skipDeviceRegistration && <div className="flex flex-col text-orange-500 text-xs gap-2">You don't need to register your device because NEXT_PUBLIC_SKIP_DEVICE_REGISTRATION is set to True.</div>}
